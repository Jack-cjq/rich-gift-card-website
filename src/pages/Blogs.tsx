...
const Blogs: React.FC = () => {
  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-b from-slate-900 via-purple-900 to-indigo-900 text-white">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="relative bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-3xl p-8 border border-cyan-400/30 backdrop-blur-sm">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <Link to={`/blog/${blogPosts[0].slug}`} className="text-cyan-300 font-semibold hover:text-cyan-200 transition-colors">
                      Read Article →
                    </Link>
                  </div>
                  ...
                  {/* Overlay Card */}
                  <div className="relative bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-2xl p-6 shadow-lg border border-cyan-400/30 backdrop-blur-sm">
                    ...
                    <div className="flex justify-end">
                      <div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl flex items-center justify-center">
              ...
              <div className="space-y-6">
                {blogPosts.slice(1).map((post) => (
                  <article key={post.id} className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2xl p-6 border border-cyan-400/30 backdrop-blur-sm">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <span className="text-xs bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-2 py-1 rounded-full mb-2 inline-block">
                          {post.category}
                        </span>
                        <h3 className="text-lg font-bold text-white mb-2">
                          {post.title}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2 text-sm text-blue-200">
                            <div className="w-6 h-6 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full"></div>
                            <span>{post.author}</span>
                            <span>•</span>
                            <span>{post.date}</span>
                          </div>
                          <Link to={`/blog/${post.slug}`} className="text-cyan-300 text-sm font-semibold hover:text-cyan-200 transition-colors">
                            Read more →
                          </Link>
                        </div>
                      </div>
      ...
      {/* Newsletter Section */}
      <section className="py-20 bg-gradient-to-br from-cyan-500/10 to-purple-500/10">
        <div className="w-full px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-3xl p-12 shadow-lg border border-cyan-400/30 backdrop-blur-sm">
              <div className="text-cyan-300 text-sm font-semibold mb-2">Stay Connected</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto mb-6">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg border border-cyan-400/50 bg-white/10 text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent"
                />
                <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-purple-600 transition-all duration-200">
                  Subscribe
                </button>
              </div>
